        ...
        for (int i = 0; i < trackers->size(); ++i) {
            ...
            if (device->bConnected) {
                ...
                zosc_t* oscMsg = zosc_create(  address.c_str(), "sfffffffffffff", 
                                            ...
                                            device->quaternion.x, device->quaternion.y, device->quaternion.z, device->quaternion.w,
                                            device->linearVelocity.x, device->linearVelocity.y, device->linearVelocity.z,
