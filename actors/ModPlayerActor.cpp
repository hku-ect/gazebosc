...
const char * ModPlayerActor::capabilities =
        ...
        "        name = \"start_position\"\n"
        "        type = \"int\"\n"
        "        help = \"Set the start position number of the song, this must be before the end position!\"\n"
        "        value = \"0\"\n"
        "        min = \"0\"\n"
        "        max = \"127\"\n"
        "        step = \"1\"\n"
        ...
        "        name = \"end_position\"\n"
        "        type = \"int\"\n"
        "        help = \"Set the end position number of the song, this must be after the start position!\"\n"
        "        value = \"127\"\n"
        "        min = \"0\"\n"
        "        max = \"127\"\n"
        "        step = \"1\"\n"
        ...
        "        name = \"row_delay\"\n"
        "        type = \"int\"\n"
        "        help = \"Set a pattern row delay as music is sometimes rendered faster than being played!\"\n"
        "        value = \"0\"\n"
        "        min = \"0\"\n"
        "        max = \"63\"\n"
        "        step = \"1\"\n"
        ...
        "        name = \"loop\"\n"
        "        type = \"bool\"\n"
        "        help = \"Loop the song or stop playing at the end. Note; some songs loop themselves!\"\n"
        "        value = \"True\"\n"
